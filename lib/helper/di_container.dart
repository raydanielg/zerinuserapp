...
import 'package:zerin_express/features/address/domain/services/address_service_interface.dart';
import 'package:zerin_express/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:zerin_express/features/auth/domain/services/auth_service.dart';
import 'package:zerin_express/features/auth/domain/services/auth_service_interface.dart';
import 'package:zerin_express/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:zerin_express/features/coupon/domain/services/coupon_service.dart';
...
import 'package:zerin_express/features/location/domain/repositories/location_repository.dart';
import 'package:zerin_express/features/location/domain/repositories/location_repository_interface.dart';
import 'package:zerin_express/features/location/domain/services/location_service.dart';
import 'package:zerin_express/features/location/domain/services/location_service_interface.dart';
import 'package:zerin_express/features/message/domain/repositories/message_repository.dart';
import 'package:zerin_express/features/message/domain/repositories/message_repository_interface.dart';
import 'package:zerin_express/features/message/domain/services/message_service.dart';
import 'package:zerin_express/features/message/domain/services/message_service_interface.dart';
import 'package:zerin_express/features/my_level/controller/level_controller.dart';
import 'package:zerin_express/features/my_level/domain/repositories/level_repository.dart';
import 'package:zerin_express/features/my_level/domain/repositories/level_repository_interface.dart';
import 'package:zerin_express/features/my_level/domain/services/level_service.dart';
import 'package:zerin_express/features/my_level/domain/services/level_service_interface.dart';
import 'package:zerin_express/features/my_offer/controller/offer_controller.dart';
import 'package:zerin_express/features/my_offer/domain/repositories/offer_repository.dart';
import 'package:zerin_express/features/my_offer/domain/repositories/offer_repository_interface.dart';
import 'package:zerin_express/features/my_offer/domain/services/offer_service.dart';
import 'package:zerin_express/features/my_offer/domain/services/offer_service_interface.dart';
import 'package:zerin_express/features/notification/controllers/notification_controller.dart';
import 'package:zerin_express/features/notification/domain/repositories/notification_repository.dart';
import 'package:zerin_express/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:zerin_express/features/notification/domain/services/notification_service.dart';
import 'package:zerin_express/features/notification/domain/services/notification_service_interface.dart';
import 'package:zerin_express/features/onboard/controllers/on_board_page_controller.dart';
import 'package:zerin_express/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:zerin_express/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:zerin_express/features/parcel/domain/services/parcel_service.dart';
import 'package:zerin_express/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:zerin_express/features/payment/controllers/payment_controller.dart';
import 'package:zerin_express/features/payment/domain/repositories/payment_repository.dart';
import 'package:zerin_express/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:zerin_express/features/payment/domain/services/payment_service.dart';
import 'package:zerin_express/features/payment/domain/services/payment_service_interface.dart';
import 'package:zerin_express/features/profile/domain/repositories/profile_repository.dart';
import 'package:zerin_express/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:zerin_express/features/profile/domain/services/profile_service.dart';
import 'package:zerin_express/features/profile/domain/services/profile_service_interface.dart';
import 'package:zerin_express/features/realtime_location_trac/controllers/location_tracking_controller.dart';
import 'package:zerin_express/features/realtime_location_trac/domain/repository/location_tracking_repository.dart';
...
import 'package:zerin_express/features/realtime_location_trac/domain/service/location_tracking_service.dart';
import 'package:zerin_express/features/realtime_location_trac/domain/service/location_tracking_service_interface.dart';
import 'package:zerin_express/features/refer_and_earn/controllers/refer_and_earn_controller.dart';
import 'package:zerin_express/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:zerin_express/features/refer_and_earn/domain/repositories/refer_earn_repository_interface.dart';
import 'package:zerin_express/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:zerin_express/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:zerin_express/features/refund_request/controllers/refund_request_controller.dart';
import 'package:zerin_express/features/refund_request/domain/repositories/refund_request_repository.dart';
import 'package:zerin_express/features/refund_request/domain/repositories/refund_request_repository_interface.dart';
import 'package:zerin_express/features/refund_request/domain/services/refund_request_service.dart';
import 'package:zerin_express/features/refund_request/domain/services/refund_request_service_interface.dart';
import 'package:zerin_express/features/ride/domain/repositories/ride_repository.dart';
import 'package:zerin_express/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:zerin_express/features/ride/domain/services/ride_service.dart';
import 'package:zerin_express/features/ride/domain/services/ride_service_interface.dart';
import 'package:zerin_express/features/safety_setup/controllers/safety_alert_controller.dart';
import 'package:zerin_express/features/safety_setup/domain/repositories/safety_alert_repository.dart';
import 'package:zerin_express/features/safety_setup/domain/repositories/safety_alert_repository_interface.dart';
import 'package:zerin_express/features/safety_setup/domain/services/safety_alert_service.dart';
import 'package:zerin_express/features/safety_setup/domain/services/safety_alert_service_interface.dart';
import 'package:zerin_express/features/splash/domain/repositories/config_repository.dart';
import 'package:zerin_express/features/splash/domain/repositories/config_repository_interface.dart';
import 'package:zerin_express/features/splash/domain/services/config_service.dart';
import 'package:zerin_express/features/splash/domain/services/config_service_interface.dart';
import 'package:zerin_express/features/support/controllers/help_support_controller.dart';
...
import 'package:zerin_express/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:zerin_express/features/dashboard/controllers/bottom_menu_controller.dart';
import 'package:zerin_express/features/address/controllers/address_controller.dart';
import 'package:zerin_express/features/home/controllers/banner_controller.dart';
import 'package:zerin_express/features/home/controllers/category_controller.dart';
import 'package:zerin_express/features/address/domain/repositories/address_repository.dart';
import 'package:zerin_express/features/home/domain/repositories/banner_repo.dart';
...
import 'package:zerin_express/features/auth/domain/repositories/auth_repository.dart';
import 'package:zerin_express/features/message/controllers/message_controller.dart';
...
import 'package:zerin_express/features/trip/domain/repositories/trip_repository.dart';
import 'package:zerin_express/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:zerin_express/features/trip/domain/services/service.dart';
...
import 'package:zerin_express/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:zerin_express/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:zerin_express/features/wallet/domain/services/wallet_service.dart';
import 'package:zerin_express/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:zerin_express/localization/language_model.dart';
