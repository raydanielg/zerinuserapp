...
import 'package:zerin_express/features/location/domain/models/place_details_model.dart';
import 'package:zerin_express/features/location/domain/models/prediction_model.dart';
import 'package:zerin_express/features/location/domain/models/zone_response.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  Future<void> saveAddressAndNavigate(Address address, LocationType type) async {
    ...
    if(type == LocationType.accessLocation) {
      ...
      if(type == LocationType.from) {
        ...
        Get.find<MapController>().showParcelAddressMarker(
  ...
  void setSenderAddress(Address? address) {
    ...
    if (address?.latitude != null && address?.longitude != null) {
      ...
      Get.find<MapController>().clearParcelAddressMarkers();
    }
    update();
  }
