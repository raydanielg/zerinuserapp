...
import 'package:zerin_express/features/my_offer/domain/models/best_offer_model.dart';
import 'package:zerin_express/helper/date_converter.dart';
import 'package:zerin_express/helper/extensin_helper.dart';
            ...
            SizedBox(width: Get.width *0.8,
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(spacing: Dimensions.paddingSizeExtraSmall, children: [
                  Text(safeTrim(offerModel.title, (Get.width*0.09).toInt()), style: textSemiBold),
