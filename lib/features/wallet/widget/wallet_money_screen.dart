...
import 'package:zerin_express/features/wallet/widget/transaction_card_widget.dart';
import 'package:zerin_express/features/wallet/widget/wallet_money_amount_widget.dart';
import 'package:zerin_express/features/wallet/widget/wallet_filter_bottom_sheet.dart';
...
import 'package:zerin_express/features/notification/widgets/notification_shimmer.dart';
import 'package:zerin_express/features/wallet/controllers/wallet_controller.dart';
import 'package:zerin_express/features/wallet/widget/custom_title.dart';
import 'package:zerin_express/common_widgets/no_data_widget.dart';
import 'package:zerin_express/common_widgets/paginated_list_widget.dart';
      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              CustomTitle(title: 'wallet_history'.tr,color: Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha:0.8)),
              InkWell(
                onTap: () {
                  Get.bottomSheet(
                    const WalletFilterBottomSheet(),
